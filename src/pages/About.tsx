...
const About = () => {
  // Core values from provided content - real company values
  const values = [
    {
      icon: Heart,
      title: "Respect",
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Mission & Vision Section - Real company mission and vision */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Mission - Real mission from provided content */}
            ...
            {/* Vision - Real vision from provided content */}
            <div className="relative">
              <div className="flex items-center mb-8">
      ...
      {/* Core Values Section - Real values from provided content */}
      ...
      {/* About Content Section - Detailed company information */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Company image with floating badge */}
            <div className="relative">
              ...
              {/* NHIS Accreditation floating badge */}
      ...
      {/* Achievements Section - Real certifications and achievements */}
