...
const Resources = () => {
  // External health resources - real links from provided content
  ...
  // Health education topics - organized by medical specialty
  const healthTopics = [
    {
      icon: Heart,
  ...
  // Downloadable resources - forms and guides for patients
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - Resources page header */}
      ...
      {/* External Resources Section - Links to trusted medical websites */}
      ...
      {/* Health Topics Section - Educational content categories */}
      ...
      {/* Downloadable Resources Section - Forms and guides */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
      ...
      {/* Emergency Information Section - Important emergency contacts */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 border-l-4 border-red-500">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              {/* Emergency contacts - real numbers from provided content */}
              <div>
