...
const Services = () => {
  // Main featured services - from provided content
  const mainServices = [
    {
      icon: Monitor,
      title: "Sleep Study",
      ...
      image: " /images//rivonia-sleep-2_orig.webp",
  ...
  // Additional services - from provided content list
  ...
  // Special services - Home care and ambulance from provided content
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - Services page header */}
      ...
      {/* Main Services Section - Featured services with detailed descriptions */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Alternating layout for main services */}
      ...
      {/* Additional Services Grid - Complete service listing */}
      ...
      {/* Special Services Section - Home care and ambulance services */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
          ...
          {/* Special services with alternating layout */}
          <div className="space-y-16">
      ...
      {/* Sleep Questionnaire CTA - Special call-to-action for sleep studies */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {/* Sleep questionnaire form link - placeholder for now */}
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
