      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Company description - real content */}
          ...
          {/* Contact Info Section - Real contact details from provided content */}
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* Phone numbers - all real numbers from provided content */}
              <div className="flex items-start space-x-3">
              ...
              {/* Email addresses - real emails from provided content */}
              <div className="flex items-start space-x-3">
        ...
        {/* Footer bottom section - Copyright and certifications */}
